...
options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"mustache-container",template:{elem:"input",type:"text",label:"Template"},data:{elem:"input",type:"text",label:"Data"},dynamic:{elem:"input",type:"text",label:"Dynamic"}}})})(Popcorn);(function(o){var e=1,h=false,j=false;if(!h){h=true;o.getScript("#",function(){j=true})}
})(Popcorn);document.addEventListener("click",function(o){o=o.target;if(o.nodeName==="A"||o.parentNode&&o.parentNode.nodeName==="A")Popcorn.instances.forEach(function(e){e.options.pauseOnLinkClicked&&e.pause()})},false);(function(o){var e={},h=0,j=document.createElement("span"),b=["webkit","Moz","ms","O",""],k=["Transform","TransitionDuration","TransitionTimingFunction"],f={},n;document.getElementsByTagName("head")[0].appendChild(j);for(var i=0,g=k.length;i<g;i++)for(var d=0,l=b.length;d<l;d++){n=b[d]+k[i];if(n in j.style){f[k[i].toLowerCase()]=n;break}}document.getElementsByTagName("head")[0].appendChild(j);o.plugin("wordriver",{manifest:{about:{name:"Popcorn WordRiver Plugin"},options:{start:{elem:"input",type:"text",
